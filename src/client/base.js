		...
		(err, stream) => {
			...
			while (op != 0) {
				if (localStorage.getItem('token') === undefined) {
					let consultar = ["Hola", "Bienvenido a la plataforma de criticas UDP", "¿Que desea hacer?", "Opciones: ", "1. Registrar usuario", "2. Iniciar Sesion", "3. Olvide mi contraseña", "0. Salir de la plataforma"]
					...
					if (localStorage.getItem('user') === 'ADMIN') { //usuario admin ya logeado
						...
						let consultar = ["Bienvenido de vuelta a la plataforma de criticas UDP", "¿Que desea hacer?", "Opciones: ", "1. Cambiar contraseña", "2. Cerrar Sesion", "3. Ver Cursos", "4. Ver mis comentarios", "0. Salir de la plataforma"]
						for (let i of consultar) {
							console.log(consultar[i]);
						}
						op = prompt("");
